...
import com.example.financetracker.adapter.SimpleTransactionAdapter
...
class DashboardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textViewAll.setOnClickListener {
            (requireActivity() as com.example.financetracker.MainActivity).bottomNavigation.selectedItemId = 
    ...
    private fun updateBudgetCard(budget: com.example.financetracker.model.Budget?) {
        lifecycleScope.launch {
            val currency = prefManager.getCurrency()
            val numberFormat = NumberFormat.getCurrencyInstance()
